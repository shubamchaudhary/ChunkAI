# LogLens — Target Architecture (FINAL, refined): Log Intelligence Pipeline
...
**LogLens answers whole-corpus analytical questions over production log archives — the question class where standard top-k RAG structurally fails.**
