...
import com.scalelogs.api.dto.request.LoginRequest;
import com.scalelogs.api.dto.request.RegisterRequest;
import com.scalelogs.api.dto.response.AuthResponse;
import com.scalelogs.api.security.JwtTokenProvider;
...
public class AuthController {
    ...
    @org.springframework.beans.factory.annotation.Value("${scalelogs.guest.session-id:}")
    private String guestSessionId;

    @org.springframework.beans.factory.annotation.Value("${scalelogs.guest.email:guest@scalelogs.demo}")
