...
public interface DocumentRepository extends JpaRepository<Document, UUID> {
    ...
    @Modifying
    @Transactional
    @Query("update Document d set d.processingStatus = com.scalelogs.common.constants.ProcessingStatus.PROCESSING "
        + "where d.id = :id")
    void markProcessing(@Param("id") UUID id);

    @Modifying
    @Transactional
    @Query("update Document d set d.processingStatus = com.scalelogs.common.constants.ProcessingStatus.COMPLETED, "
    ...
    @Modifying
    @Transactional
    @Query("update Document d set d.processingStatus = com.scalelogs.common.constants.ProcessingStatus.FAILED, "
