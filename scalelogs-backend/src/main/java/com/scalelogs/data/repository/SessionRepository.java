package com.scalelogs.data.repository;

import com.scalelogs.common.constants.AnalysisStatus;
import com.scalelogs.data.entity.Session;
...
public interface SessionRepository extends JpaRepository<Session, UUID> {
    ...
    @Modifying
    @Transactional
    @Query("update Session s set s.analysisStatus = com.scalelogs.common.constants.AnalysisStatus.FAILED, "
    ...
    @Modifying
    @Transactional
    @Query("update Session s set s.analysisStatus = com.scalelogs.common.constants.AnalysisStatus.CORRELATING "
        + "where s.id = :id and s.analysisStatus = com.scalelogs.common.constants.AnalysisStatus.ENRICHING")
