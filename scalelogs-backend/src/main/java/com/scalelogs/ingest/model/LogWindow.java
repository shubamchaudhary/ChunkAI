package com.scalelogs.ingest.model;
 ...
 * same {@code scalelogs.window-seconds} bucket.
 *
 * <p>Mutable by design: {@link #chunkId} is assigned just before the chunk is
 * inserted, and {@link #anomalous} is set by {@link com.scalelogs.ingest.AnomalyDetector}
