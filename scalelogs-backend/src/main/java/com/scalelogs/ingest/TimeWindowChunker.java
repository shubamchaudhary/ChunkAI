...
/**
 * Groups log lines into fixed-width time windows ({@code scalelogs.window-seconds},
...
public class TimeWindowChunker {
    ...
    public TimeWindowChunker(@Value("${scalelogs.window-seconds:60}") long windowSeconds) {
