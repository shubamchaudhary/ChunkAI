...
public class MinioStorageService implements FileStorageService {
    ...
    public MinioStorageService(
        @Value("${scalelogs.minio.endpoint}") String endpoint,
        @Value("${scalelogs.minio.access-key}") String accessKey,
        @Value("${scalelogs.minio.secret-key}") String secretKey,
        @Value("${scalelogs.minio.bucket}") String bucket
    ) {
